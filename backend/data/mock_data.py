...
FINANCE_NAMES = [
    ...
    "万晓峰", "段春华", "雷雅芬", "钱志豪", "汤秀兰", "尹文博", "黎丽娟",
    "易建华", "常晓红", "武志远", "乔文静", "贺永康", "赖丽萍", "龚建国",
    "文红梅", "庞浩然", "纪慧敏", "羊志刚", "那丽君", "瞿建明", "全晓峰",
    "褚春华", "池祥瑞", "桑雅芬", "桂志豪", "牛秀兰", "温文博", "庄丽娟",
    "柴建华", "祝晓红", "查志远", "单文静", "柯永康", "房丽萍", "戚建国",
    "解红梅", "强浩然", "苗慧敏", "凌志刚", "毕丽君", "诸建明", "郎晓峰",
    "屈春华", "路祥瑞", "童雅芬", "颜志豪", "萧文静", "蓝永康", "聂丽萍",
    "关建国", "纪红梅", "左浩然", "尤慧敏", "管志刚", "符丽君", "岳建明",
    "商晓峰", "牟春华", "席祥瑞", "鄢雅芬", "束志豪", "游秀兰", "竺文博",
    "柏丽娟", "充建华", "宓晓红", "隗志远", "蓬文静", "郗永康", "班丽萍",
]
...
_ENT_NAMES = [
    ...
    "中科智慧城市科技有限公司", "东方融资租赁有限公司", "海通证券投资有限公司",
    "长江基建工程集团有限公司", "华联商业保理有限公司", "国泰基金管理有限公司",
    "泰康人寿保险代理有限公司", "中远海运物流有限公司", "宝钢特钢材料有限公司",
    "京东方光电科技有限公司", "宁德时代供应链有限公司", "比亚迪零部件有限公司",
    "隆基绿能光伏有限公司", "中芯集成电路有限公司", "腾讯云计算有限公司",
    "阿里数字科技有限公司", "华为技术合作有限公司", "小米智能制造有限公司",
    "美团本地服务有限公司", "京东供应链管理有限公司", "字节跳动广告有限公司",
    "网易互娱科技有限公司", "百度人工智能有限公司", "拼多多农业有限公司",
    "顺丰冷链物流有限公司", "中通快递运营有限公司", "圆通速递网络有限公司",
    "韵达供应链服务有限公司", "申通快递科技有限公司", "极兔速递有限公司",
    "万达商业管理有限公司", "龙湖地产开发有限公司", "碧桂园城市建设有限公司",
    "万科物业管理有限公司", "保利发展控股集团有限公司", "融创文化旅游有限公司",
    "恒大新能源汽车有限公司", "蔚来汽车科技有限公司", "小鹏智能汽车有限公司",
    "理想汽车制造有限公司", "零跑汽车科技有限公司", "哪吒新能源有限公司",
    "中粮食品集团有限公司", "蒙牛乳业股份有限公司", "伊利实业集团股份有限公司",
    "贵州茅台酒股份有限公司", "五粮液集团有限公司", "泸州老窖股份有限公司",
    "海天调味食品有限公司", "双汇食品发展有限公司", "青岛啤酒股份有限公司",
    "中国移动通信有限公司", "中国电信集团有限公司", "中国联通网络有限公司",
    "国家电网有限公司", "南方电网有限公司", "中国石油天然气有限公司",
    "中国石化化工有限公司", "中国海洋石油有限公司", "中国建筑集团有限公司",
    "中国中铁工程有限公司", "中国铁建股份有限公司", "中国交建集团有限公司",
    "中信证券股份有限公司", "招商银行科技有限公司", "平安保险集团有限公司",
    "太平洋保险有限公司", "中国人寿保险有限公司", "新华保险股份有限公司",
    "光大证券股份有限公司", "国泰君安证券有限公司", "华泰证券股份有限公司",
    "广发证券股份有限公司", "海通证券股份有限公司", "中金公司有限公司",
]
...
# ── 个人客户 ─────────────────────────────────────────
def generate_personal_customers(n: int = 500) -> List[Dict[str, Any]]:
    random.seed(42)
...
# ── 企业客户 ─────────────────────────────────────────
def generate_enterprise_customers(n: int = 100) -> List[Dict[str, Any]]:
    random.seed(2026)
    enterprises = []
    for i in range(1, n + 1):
        eid = f"E{i:03d}"
...
def get_personal_customers() -> List[Dict[str, Any]]:
    ...
    if _personal_cache is None:
        _personal_cache = generate_personal_customers()
...
def get_enterprise_customers() -> List[Dict[str, Any]]:
    ...
    if _enterprise_cache is None:
        _enterprise_cache = generate_enterprise_customers()
